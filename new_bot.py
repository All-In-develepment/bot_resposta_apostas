...
def responder(mensagem):
    try:
        codigo, resposta, botoes = verificar_mensagem(mensagem.text)
...
def obter_destino(mensagem, codigo):
    try:
        ...
        link = f"https://go.aff.estrelabetpartners.com/av6et8zh?campaign_id=13830&utm_campaign={utm_campaign}&aposta={codigo}"
